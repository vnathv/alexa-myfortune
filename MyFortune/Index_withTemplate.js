...
//var intentHandlers = require('./Intent.js')
var intentHandlers = {};
...
function onLaunch(launchRequest, session, response) {
    ...
    response.speechText = 'Welcome to my fortune';
    response.repromptText = 'You can say for example, ask my fortune about aries today';
    response.shouldEndSession = false;
    response.done();
}


intentHandlers['MyFortuneIntent'] = function (request, session, response, slots) {
